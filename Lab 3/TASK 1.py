...
class PaperBook(Book):
    """ Класс для бумажной книги, наследует от Book. """
    def __init__(self, name: str, author: str, pages: int):
        super().__init__(name, author)
        self.pages = pages  # Вызов setter для pages
...
class AudioBook(Book):
    """ Класс для аудиокниги, наследует от Book. """
    def __init__(self, name: str, author: str, duration: float):
        super().__init__(name, author)
        self.duration = duration  # Вызов setter для duration
...
paper_book = PaperBook("Мы", "Замятин", 300)
audio_book = AudioBook("На дне", "Горький", 36.5)
